                    ...
                    <div className=" absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
                        <div className="flex flex-row p-6">
                            ...
                            <div className="flex flex-col mt-4">
                                ...
                                <p className="text-lg text-white/70 mt-2">I hold a degree in Computer Science and I am Focusing on technologies like React-Js, Next-Js, and Tailwind-CSS</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className=" absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
                        <div className="flex flex-row p-6">
                            ...
                            <div className="flex flex-col mt-4">
                                ...
                                <p className="text-lg text-white/70 mt-2">As Full-Stack Web Developer, I specialize in Salesforce, React-Js, Next-Js, and Tailwind-CSS. My expertise extends to creating responsive, user-friendly interfce and efficient Back-End solutions.</p>
                            </div>
                        </div>
                    </div>
